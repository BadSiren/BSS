...
namespace BSS.Unit {
	...
	public class HealthBar : MonoBehaviour {
			...
			if (HealthBarGui.displayValue) {
				...
				GUI.Label(
					...
					new Rect(
						...
						20)
					*/
					currentValue.ToString("#")+" / "+maxHealth.ToString("#"),
		...
		public void AssignMaxHealthValue(float newValue) {
			maxHealth = newValue;
		}
		public void AssignHealthValue(float newValue) {
			Health = newValue;
		}
